...
import com.project.chatapp.presenter.ProfilePresenter;
...
public class ProfileActivity extends AppCompatActivity implements ProfilePresenter.View, QiscusPermissionsUtil.PermissionCallbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(v -> profilePresenter.logout());
        ...
        ivAvatar.setOnClickListener(v -> {
            ...
            linImageGallery.setOnClickListener(v12 -> {
                //gallery
            ...
            linTakePhoto.setOnClickListener(v1 -> {
                //camera
